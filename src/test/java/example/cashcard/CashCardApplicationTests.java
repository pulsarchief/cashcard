...
class CashCardApplicationTests {
    ...
    @Test
    void shoulldReturnPageOfCashCards() {
    ...
    void shouldRejectUsersWhoAreNotCardOwners() {
        ...
        ResponseEntity<String> response = restTemplate.withBasicAuth("hank-own-no-cards", "qrs456")
    ...
    void shouldNotUpdateACashCardThatDoesNotExist() {
        ...
        ResponseEntity<Void> response = restTemplate.withBasicAuth("sarah1", "abc123").exchange("/cashcards/9999",
                HttpMethod.PUT, request, Void.class);
    ...
    void shouldNotAllowDeletionOfCashCardsTheyDoNotOwn() {
        ...
        ResponseEntity<String> getResponse = restTemplate.withBasicAuth("kumar2",
                "xyz789").getForEntity("/cashcards/102", String.class);
        assertThat(getResponse.getStatusCode()).isEqualTo(HttpStatus.OK);
    }
}
